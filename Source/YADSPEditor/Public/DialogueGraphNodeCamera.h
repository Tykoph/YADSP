...
#include "DialogueGraphNodeCamera.Generated.h"

UCLASS()
class UDialogueGraphNodeCamera : public UDialogueGraphNodeBase
{
	GENERATED_BODY()
...
public: // UEdGraphNode interface
	...
	virtual EDialogueNodeType GetNodeType() const override { return EDialogueNodeType::CameraNode; }
